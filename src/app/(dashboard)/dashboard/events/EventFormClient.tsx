...
export default function EventFormClient({ business, districts }: any) {
  ...
  const handleSubmit = async (e: React.FormEvent, status: 'upcoming' | 'draft' = 'upcoming') => {
    e.preventDefault()
    setIsSaving(true)
      ...
      <div className="max-w-4xl mx-auto pb-20">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
             ...
             <button onClick={e => handleSubmit(e, 'upcoming')} disabled={isSaving} className="flex-1 sm:flex-none px-6 py-2.5 bg-orange-600 text-white font-bold rounded-xl hover:bg-orange-700 transition flex items-center justify-center min-w-[140px] shadow-sm">
