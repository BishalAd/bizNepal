# BizNepal Telegram Bot — FINAL WORKFLOW (Import This)

## How to Import
1. Open n8n → **New Workflow** 
2. Click **⋯ menu** → **Import from JSON**
3. Paste the entire JSON block below
4. Set your credentials on the Telegram nodes (select your "BizNepal Bot" API key)
...
```json
{
  "name": "BizNepal Telegram Signup (Final — Dispatcher Architecture)",
  "nodes": [
    {
      "parameters": {
