{
  "name": "BizNepal Telegram Chatbot Signup (DB Verified)",
  "nodes": [
    {
      "parameters": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={\n  \"id\": \"{{$json.user.id}}\",\n  \"email\": \"{{$('Session Manager').item.json.sessionData.email}}\",\n  \"full_name\": \"{{$('Session Manager').item.json.sessionData.fullname}}\",\n  \"role\": \"{{$('Session Manager').item.json.sessionData.role === 'business' ? 'business_owner' : 'user'}}\",\n  \"phone\": \"{{$('Session Manager').item.json.sessionData.phone}}\"\n}",
        "options": {}
      },
