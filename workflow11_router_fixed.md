```json
{
  "name": "BizNepal Telegram Signup (Router Limits Fixed)",
  "nodes": [
    {
      "parameters": {
        "updates": [
    ...
    },
    {
      "parameters": {
        "conditions": {
          "string": [
            {
              "value1": "={{ $node[\"Session Manager\"].json.sessionData.role }}",
              "value2": "business"
            }
          ]
        }
  ...
  "connections": {
    ...
    "Supabase SignUp Auth": {
      "main": [
        [
          {
            "node": "Supabase Insert DB User",
            "type": "main",
            "index": 0
          }
        ]
    ...
    "Supabase Insert DB User": {
      "main": [
        [
          {
            "node": "Check Business Submit",
            "type": "main",
            "index": 0
          }
        ]
    ...
    "Check Business Submit": {
      "main": [
        [
          {
            "node": "Supabase Insert Business",
            "type": "main",
            "index": 0
          }
        ],
